...
/**
 * Encapsulates a single tab-delimited QTLMarkers file record.
 ...
 */
public class QTLMarkersRecord implements Comparable {
    ...
    /**
     * Instantiate from a line from a QTLMarkers file. Do nothing if it's a header line.
     */
    public QTLMarkersRecord(String line) {
    ...
    public int compareTo(Object o) {
        QTLMarkersRecord that = (QTLMarkersRecord)o;
